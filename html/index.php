...
<td width="24%" align="center"><a href="/index.php?section=logfiles"><span style="color:white">Logdateien</span></a></td>
...
if ($_GET['section']=="netoverview") {
  if ($_GET['submit']=="Tagesanzeige") {
      $output = shell_exec('A=`ls -rt /var/www/html/files/logday*.log | tail -1`; perl /home/pi/perl/log2dot.pl $A > /var/www/html/files/tmp.dot');
  } else {
